...
let grades=[
    {id:1,name:"Chapu",course:"CS572",grade:"A"},
    {id:2,name:"Lali",course:"CS572",grade:"A"},
    {id:3,name:"Tati",course:"CS572",grade:"B"}
];
...
app.post('/grades',[check('id').isNumeric().withMessage('ID shoudl not be empty and it is numeric')
